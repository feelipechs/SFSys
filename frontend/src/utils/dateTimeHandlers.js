// converte string ISO para objeto Date (para o useState/Calendar)
export const createDateObject = (isoString) => {
  if (!isoString) return undefined;
  return new Date(isoString);
};

// extrai HH:MM:SS de string ISO (para o Input Time)
...
// combina Date e Time em string ISO/UTC (para o onChange do react-hook-form)
