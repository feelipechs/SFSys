...
export const MultiSelect = React.forwardRef(
  (
    ...
    const prevSelectedCount = React.useRef(value.length);
    ...
    React.useImperativeHandle(
      ...
      [resetToDefault, value, onValueChange]
    );
    ...
    React.useEffect(() => {
      ...
      if (selectedCount !== prevSelectedCount.current) {
        ...
        if (diff > 0) {
          const addedItems = value.slice(-diff);
    ...
    }, [value, isPopoverOpen, searchValue, announce, getAllOptions]);
        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              aria-label={`Multi-select: ${value.length} of ${
                ...
                <div className="flex justify-between items-center w-full">
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      aria-label={`Clear all ${value.length} selected options`}
