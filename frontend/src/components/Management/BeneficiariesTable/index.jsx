...
const beneficiariesData = [
  {
    id: 'b1',
    name: 'Beneficiario 01',
    email: 'beneficiario.01@email.com',
  ...
  {
    id: 'b2',
    name: 'Beneficiario 02',
    email: 'beneficiario.02@email.com',
    registrationDate: '17/10/2025',
    campaigns: [{ id: 'c3', title: 'Campanha 03', description: '...' }],
  },
];

const BeneficiarieRow = ({ beneficiarie }) => {
  const { name, email, registrationDate, campaigns } = beneficiarie;
    ...
    <div className="overflow-x-auto">
      ...
      <table className="min-w-full divide-y-2 divide-gray-200 dark:divide-gray-700">
        ...
        <tbody className="divide-y divide-gray-200 *:even:bg-gray-50 dark:divide-gray-700 dark:*:even:bg-gray-800">
          {beneficiariesData.map((beneficiarie) => (
            <BeneficiarieRow
              key={beneficiarie.id} // Use algo único como 'key' (ex: email, id)
